          ...
          <div>
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="px-4 py-2 rounded-md text-coffee-dark w-full sm:w-auto"
              />
              <button type="submit" className="bg-coffee text-white px-4 py-2 rounded-md hover:bg-coffee-light transition-colors">
                Đăng ký
              </button>
            </form>
            <div className="mt-6">
              <p className="mb-2">Theo dõi chúng tôi</p>
